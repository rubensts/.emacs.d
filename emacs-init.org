...
| ~a~          | open directory in the current buffer (=dired-find-alternate-file=)               |
| ~n~          | go next line        (=dired-next-line)=                                          |
| ~p~          | go prevous line     (=dired-previous-line)=                                      |
| ~m~          | mark files/dir      (=dired-mark)=                                               |
| ~u~          | unmark files/dir    (=dired-unmark)=                                             |
| ~&~          | run shell commands  (=dired-do-async-shell-command)                             |
| ~c~          | compress files/dir  (=dired-do-compress-to=) Mark them first. Details in [[http://oremacs.com/2015/10/23/dired-compress/][oremacs]] |
| ~z~          | compress/decompress (=dired-do-compress)=                                        |
...
;; let's also use async everything in dried
